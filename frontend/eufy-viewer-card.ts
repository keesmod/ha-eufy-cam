...
export class EufyViewerCard extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot!.querySelector<HTMLElement>(".age")!.textContent = date && !Number.isNaN(date.valueOf()) ? `${text.received}: ${date.toLocaleString(this._hass.language)} · ${text.unknown}` : "";
