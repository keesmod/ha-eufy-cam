...
The current card resource is `/eufy_viewer/eufy-viewer-card.js?v=0.8.34`.
...
`live_autostart: true`. Update the integration to **0.8.34** and the bridge to
**0.8.27**, then refresh the dashboard.
