...
The current card resource is `/eufy_viewer/eufy-viewer-card.js?v=0.8.28`.
...
The **0.8.28** integration and bridge **0.8.23** keep live diagnostics for the
...
`live_autostart: true`. Update the integration to **0.8.28** and the bridge to
