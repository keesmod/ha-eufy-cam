...
The current card resource is `/eufy_viewer/eufy-viewer-card.js?v=0.8.29`.
...
The **0.8.29** integration adds the browser's decoder name and its freeze,
...
`live_autostart: true`. Update the integration to **0.8.29** and the bridge to
